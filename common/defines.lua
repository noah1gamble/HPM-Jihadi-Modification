...
country = {
    ...
    BADBOY_LIMIT = 30,  -- Jihadi Modification - Raised to 30
    ...
    CREATED_CB_VALID_TIME = 24,  -- how many months -- Jihadi Modification - Raised to 24
    ...
    COLONIZATION_COLONY_STATE_DISTANCE = 800, -- Jihadi Modification - Raised from 400 to 800 
...
economy = {
    ...
    BANKRUPCY_DURATION = 4, -- Years till a bankruptcy clears all loans -- Jihadi Modification - Changed from 3 to 4
...
diplomacy = {
    ...
    INFAMY_CONCEDE = 1,
    INFAMY_STATUS_QUO = 0,
    INFAMY_ANNEX = 8, -- CHANGED TO 8 - JIHADI MODIFICATION
