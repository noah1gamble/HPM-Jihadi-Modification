//Line 46 contains the float(R,G,B) values that you can adjust for the FOW.
...
const float3 GREYIFY = float3( 0.312671, 0.815160, 0.172169 ); //Vanilla values ( 0.212671, 0.715160, 0.072169 )
