//Line 423 contains the value you can adjust, FOW = saturate ( FOW + X ), change the X value to adjust transparency 0-1. Higher is more transparent.
...
float4 PixelShader_HoiWater_2_0( VS_OUTPUT_WATER IN ) : COLOR
{
	...
	FOW = saturate ( FOW + 0.8 ); //Vanilla code line FOW = saturate ( FOW + 0.5 )
